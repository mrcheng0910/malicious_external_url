...
from ..TelephoneData.handle_phone import Handle_tel
...
def get_result(domain_punycode, tld, whois_addr, func_name, data, flag):
    ...
    tel_result = Handle_tel().handletel(domain_whois['reg_phone'])
    domain_whois['phone_country_code'] = tel_result['country']
    domain_whois['phone_position_code'] = tel_result['province']+'-'+tel_result['city']
    domain_whois['phone_number'] = tel_result['nu_n']
    domain_whois['phone_type'] = len(str(tel_result['nu_n']))
    return domain_whois
